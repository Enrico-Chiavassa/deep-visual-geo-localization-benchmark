...
for epoch_num in range(start_epoch_num, args.epochs_num):
    ...
    if is_best:
        logging.info(f"Improved: previous best R@5 = {best_r5:.1f}, current R@5 = {recalls[0][1]:.1f}")
        best_r5 = recalls[0][1]
        not_improved_num = 0
    else:
        not_improved_num += 1
        logging.info(f"Not improved: {not_improved_num} / {args.patience}: best R@5 = {best_r5:.1f}, current R@5 = {recalls[0][1]:.1f}")
